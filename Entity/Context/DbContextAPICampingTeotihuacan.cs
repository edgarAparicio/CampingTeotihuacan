...
namespace EdgarAparicio.APICampingTeotihuacan.Manager.Entity.Context
{
    public class DbContextAPICampingTeotihuacan : DbContext
    {
        public DbSet<Camp> Camps { get; set; }
        public DbSet<Speaker> Speakers { get; set; }
        public DbSet<Talk> Talks { get; set; }
        public DbContextAPICampingTeotihuacan(DbContextOptions<DbContextAPICampingTeotihuacan> options) : base(options)
        {
